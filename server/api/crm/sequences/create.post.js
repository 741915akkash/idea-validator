  ...
  try {
    ...
    const sequenceInsert = await client.query(
      `
        ...
        VALUES ($1, $2, $3)
        RETURNING id, user_id, title, business_days_only, created_at, updated_at
      `,
