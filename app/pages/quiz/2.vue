...
<template>
  <main class="px-6 py-6">
    <div class="mx-auto max-w-4xl">
      ...
      <div
        class="mb-3 flex items-center justify-between rounded-lg border border-slate-200 bg-white px-4 py-3"
      >
        ...
        <div class="mt-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              class="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-emerald-500"
            />
          </div>
          ...
          <div>
            ...
            <input
              :value="user.email"
              disabled
              class="mt-1 w-full rounded-lg border border-gray-100 bg-gray-50 px-3 py-2 text-sm text-gray-500"
            />
          </div>
