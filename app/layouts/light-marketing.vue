<script setup>
import { ref } from 'vue'
import { Menu, Orbit, X } from 'lucide-vue-next'
    ...
    >
      <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav class="hidden items-center gap-6 text-sm font-medium text-slate-700 md:flex">
          ...
          <NuxtLink to="/general/pricing" class="transition hover:text-slate-900">
            Pricing
          </NuxtLink>

          <NuxtLink to="/blog" class="transition hover:text-slate-900">
            Blog
          </NuxtLink>
